        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/services/civil-construction" className="text-muted-foreground hover:text-primary">
                  Civil & Construction
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/plant-hire" className="text-muted-foreground hover:text-primary">
                  Plant Hire
                </Link>
              </li>
            </ul>

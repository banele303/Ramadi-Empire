...
export default function SupplyPage() {
  return (
    <div className="flex flex-col">
      <main className="flex-1 py-12 md:py-16 px-[1rem]">
        <div className="flex flex-col">
          <div className="flex flex-col gap-2 mb-8">
            <Link href="/" className="text-sm text-muted-foreground hover:text-primary flex items-center">
              <ChevronRight className="h-4 w-4 mr-1 rotate-180" /> Back to Home what
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden">
              <Image src="/sss1.jpg" alt="Construction supplies" fill className="object-cover" />
            </div>
            <div className="flex flex-col justify-center">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                of high-quality products and reliable delivery. Our supply services are designed to support your
                projects with the materials and equipment you need, when you need them.
              </p>
              <p className="text-muted-foreground mb-4">
                We work with trusted suppliers and manufacturers to source the best products for your specific
                requirements, ensuring quality, reliability, and value for money.
              </p>
              <div className="mt-4">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-card rounded-lg p-6 shadow-sm border">
                ...
                <p className="text-muted-foreground mb-4">
                  Essential hardware items for construction and maintenance projects, ensuring durability and
                  reliability.
                </p>
                <ul className="list-disc list-inside text-muted-foreground space-y-1 mb-4">
          ...
          <div className="bg-muted/30 rounded-lg p-8 mb-12">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-2/3">
                ...
                <p className="text-muted-foreground mb-4">
                  Contact us today to discuss your supply needs. Our team will help you source the right products for
      ...
      <footer className="bg-muted py-6 px-[1rem] border-t mb-[-46rem]">
